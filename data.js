const portfolio = {
  ...
  // ترتیب رشته‌استوری‌ها از بالا به پایین (اولین‌ها در بالا، جدیدترین در پایین‌ترین نقطه)
  storyGroups: [
    {
      groupTitle: "01. روبرو شدن با یک نقد، فرصتی برای شفافیت: بررسی فنی موم گیاهی در برابر پارافین", // استوری خانم‌ها (اولین در بالا)
      items: [
    ...
    {
      groupTitle: "02. یادگاری تا ابد: ارزش‌گذاری و مقایسه باکس گل شمعی با هدایای مرسوم نامزدی و عروسی", // هدیه دوم
      items: [
    ...
    {
      groupTitle: "03. تبدیل حسرت به خرید: استراتژی ایجاد FOMO و ارزش‌آفرینی برای باکس‌های هدیه", // استوری سوم
      items: [
    ...
    {
      groupTitle: "04. روایت تصویری ایونت حلمان پلاس؛ حال‌وهوای یک دورهمی متفاوت و روز کاری آلکا", // ایونت جدید (قرار گرفته در پایین‌ترین بخش صفحه)
      items: [
        ...
        { src: "images/uploads/stories/Matin_story/Screenshot_2026-02-18-17-22-11-380_com.instagram.android.jpg", alt: "استوری Alka", index: "26" },
